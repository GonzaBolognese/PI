    ...
    return(
        <div className={style.container}>            
            <form onSubmit={onSubmit}>
                <input type='text' placeholder="Search breed" onChange={onInputChange} value={search}  className={style.search}/>
                <input type='submit' value='Buscar' className={style.buttonSrc} />
            </form>
        </div>
